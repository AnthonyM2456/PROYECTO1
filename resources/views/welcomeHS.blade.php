            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1>Productos Artesanales Peruanos
                        </h1>
                        <p class="mb-4">Descubre una variedad de productos artesanales únicos, desde artículos
                            decorativos hasta objetos de uso diario. Cada pieza es elaborada con amor y dedicación por
                            talentosos artesanos peruanos, ofreciendo lo mejor de nuestra cultura en cada detalle.</p>
                        <p><a href="" class="btn btn-secondary me-2">Compra Ahora</a><a href="#"
                                class="btn btn-white-outline">Explora Nuestros Productos</a></p>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="hero-img-wrap">
                        <img src="images/mainHS.png" class="img-fluid" alt="Productos Artesanales">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    <h2 class="mb-4 section-title">Más Vendidos</h2>
                    <p class="mb-4">Explora nuestra selección de los productos más populares entre nuestros clientes.
                        ¡Consíguelos antes de que se agoten!</p>
                    <p><a href="{{ route('products.index') }}" class="btn btn-primary">Ver Tienda</a></p>
                </div>
                <!-- End Column 1 -->
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ route('products.show', $product->id) }}">
                        ...
                        <span class="icon-cross">
                            <img src="images/cross.svg" class="img-fluid" alt="Icon">
                        </span>
                    </a>
                </div>
                @endforeach
